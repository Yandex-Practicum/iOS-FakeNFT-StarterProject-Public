...
#### Верстка
- Экран профиля и редактирование экрана профиля (est: 1 час; fact: x часов).
- Фото профиля (est: 1 час; fact: x часов).
- Кнопки для перехода на страницы "Мои NFT", "Избранные NFT", "О разработчике"- (est: 1 час; fact: х часов)

#### Логика
- Редактирование профиля (имя пользователя, описание, сайт и ссылка на изображение) (est: 1 час; fact: x часов).
