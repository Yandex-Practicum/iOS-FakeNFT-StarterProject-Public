...
private extension CheckoutViewController {
    ...
    func setupNavBar() {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.yaBlackLight]
...
extension CheckoutViewController: PayViewDelegate {
    ...
    func displayPaymentResult(success: Bool) {
        ...
        if success {
            content = .init(
                image: UIImage(named: "paymentError"),
            ...
            content = .init(
                image: UIImage(named: "paymentSuccess"),
