...
protocol Routable: AnyObject {
    ...
    func pushViewControllerFromTabbar(_ viewController: Presentable?, animated: Bool)
...
extension Router: Routable {
    ...
    func pushViewController(_ viewController: Presentable?, animated: Bool) {
        guard
            ...
            let navController = delegate?.returnRootViewController() as? UINavigationController
        else { return }
        self.currentViewController = navController
        navController.pushViewController(vc, animated: animated)
    }
